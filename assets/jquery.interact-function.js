...
var AloReference = (function Alo($){ 
  ...
  $(window).on('load resize', function () {
      let mobile = window.matchMedia(`(max-width: ${mobileScreen}px)`);
      if(mobile.matches){
  ...
  Alothemes.SwitchRTL = function () {
      $(document).on('click', '.switch-rtl-ltr', function() {
          ...
          if(!$('#rtl-style').length){
              $('head').append('<link rel="stylesheet" id="rtl-style" href="//pixilabdesignstudio.com/cdn/shop/t/2/assets/style.rtl.css?v=1188" type="text/css" />');
          }
      });
  }();
      ...
      ProductTextCountdown.prototype = $.extend({}, ProductTextCountdown.prototype, {
          ...
          init: function ($elems) {
              ...
              $countdown.each(function () {
                  ...
                  date_counter.setHours(date_counter.getHours() + reset_time);
          ...
          _resultToHTML: function ($items, data, callback) {
              ...
              for (var i = 0; i < data.params.length; i++) {
                  $.each(data.params[i], function (k, v) {
                      ...
                      Shopify.setPriceHtml($price[0], product.price, product.compare_at_price);
                      ...
                      fetch(Shopify.routes.root + 'cart/add.js', {
                        ...
                        .then((response) => {
                          ...
                          if (response.status) {
                            ...
                            // var htmlPopup = eval('`'+ response.sections.ajaxcart +'`');
                            // $.magnificPopup.open({
                            //     items: {
                            //       src: htmlPopup,
                            //       type: 'inline'
